...
public class DBConnection {
	...
	static void createCompanyDb(String databaseName) {
        ...
        try {
        	connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/","root","Anil16@db");
	...
	static Connection connect() {
		try {
			if(connection == null) {
				...
				connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/company", "root", "Anil16@db");
			}
